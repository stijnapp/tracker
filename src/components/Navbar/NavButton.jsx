...
export default function NavButton({ to, icon, text }) {
    ...
    return (
        <NavLink to={to} className={({ isActive }) => `${navButtonClasses} ${isActive ? 'text-primary -translate-y-1 font-bold drop-shadow-lg' : 'text-gray-500 dark:text-gray-400 font-medium'}`}>
