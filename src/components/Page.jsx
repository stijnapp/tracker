...
export default function Page({ title = "", className = "", children }) {
    ...
    return (
        <>
            <div className={`${isScrolling ? 'border-b bg-floating-light/90 dark:bg-floating-dark/90 backdrop-blur' : 'bg-transparent backdrop-blur-none'} transition-[background-color,border] fixed top-0 left-0 z-10 w-full border-gray-300 dark:border-white/20 theme-transition`}>
